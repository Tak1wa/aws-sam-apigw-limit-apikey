...
```bash
hoge2020removekey$ sam local invoke helloFromLambdaFunction --no-event
```
...
Resources:
  ...
  helloFromLambdaFunction:
    ...
    Properties:
      CodeUri: ./src/hoge2020removekey/
      Handler: hoge2020removekey::hoge2020removekey.Function::FunctionHandler
      Runtime: dotnet6
      MemorySize: 256
      Timeout: 100
      DeadLetterQueue:
...
```bash
hoge2020removekey$ sam logs -n helloFromLambdaFunction --stack-name sam-app --tail
```
...
```bash
hoge2020removekey$ dotnet test test/hoge2020removekey.Tests/hoge2020removekey.Tests.csproj 
```
...
```bash
aws cloudformation delete-stack --stack-name hoge2020removekey
```
